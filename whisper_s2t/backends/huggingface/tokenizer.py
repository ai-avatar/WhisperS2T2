# Modified from CTranslate2 tokenizer.py
import os
...
class Tokenizer:
    ...
    def transcribe(self) -> int:
        return self.token_to_id("<|transcribe|>")

    @cached_property
    def translate(self) -> int:
        return self.token_to_id("<|translate|>")
    ...
    @cached_property
    def sot(self) -> int:
        return self.token_to_id("<|startoftranscript|>")

    @cached_property
    def sot_lm(self) -> int:
        return self.token_to_id("<|startoflm|>")

    @cached_property
    def sot_prev(self) -> int:
        return self.token_to_id("<|startofprev|>")
    ...
    def no_timestamps(self) -> int:
        return self.token_to_id("<|notimestamps|>")
